        ...
        @if(!empty($final_orders[$i]))
            ...
            <table>
                <tr style="text-align: left;">
                    ...
                    <td></td>
                    <td style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"><strong>&nbsp;&nbsp;Naloženo</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"><strong>&nbsp;&nbsp;Vráceno</strong></td>
                </tr>
                @if($items['brambory_k'] > 0)
                <tr>
                    <td>Brambory konzumní:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['brambory_k']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Brambory malé:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['brambory_m']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['brambory_l']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['brambory_v']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['brambory_c']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Cibule:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['cibule']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Česnek:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['cesnek']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Borůvky:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['boruvky']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Cibule 25kg:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">
                        {{ $items['cibule_25'] }} Kg
                    </td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                ...
                <tr>
                    <td>Plátky syrové:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['platky_syrove']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['hranolky_syrove']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['varene_krajene']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Vařené kostky:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['varene_kostky']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Vařené plátky:</td>
                    <td>&nbsp;</td>
                    <td style="border-right:1px solid black;width:150px;">{{$items['varene_platky']}} Kg</td>
                    <td></td>
                    <td  style="border-right:1px solid black;width:150px;"></td>
                    <td></td>
                    <td></td>
